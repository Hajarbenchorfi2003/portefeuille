            ...
            <div className="col-xs-4 col-sm-4 col-md-4 col-lg-4">
              ...
              <div className="logo">
                <Link href="/" legacyBehavior>
                  <a>
                    <span className="text-2xl font-bold">Hajar Benchorfi</span>
                  </a>
                </Link>
              </div>
            </div>
                    ...
                    <div className="row">
                      <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div className="menu-social-links">
                          <a
                            href="https://github.com/Hajarbenchorfi2003"
                            target="blank"
                          ...
                          <a
                            href="https://www.linkedin.com/in/hajar-benchorfi-72183a294"
                            target="blank"
                            className="scrolla-element-anim-1"
                            title="linkedin"
                          >
